...
with open('include/aslam_cv_serialization/cameras/CameraBaseSerialization.hpp','w') as outf:
...
for cam in cameras:
    ...
    with open(fname,'w') as outf:
        outf.write('#include <aslam_cv_serialization/cameras/CameraBaseSerialization.hpp>\n\n')
...
with open('include/aslam_cv_serialization/FrameBaseSerialization.hpp','w') as outf:
...
for cam in cameras:
    ...
    with open(fname,'w') as outf:
        outf.write("// THIS FILE HAS BEEN AUTOGENERATED BY gen_files.py\n")
        outf.write('#include <aslam_cameras/cameras.hpp>\n')
        outf.write('#include <aslam_cameras/Frame.hpp>\n')
        outf.write('#include <aslam_cv_serialization/FrameBaseSerialization.hpp>\n\n')
        outf.write(BOOST_SERIALIZATION_HEADERS)
...
with open('src/LinkCvSerialization.cpp', 'w') as outf:
    outf.write('#include <aslam_cv_serialization/LinkCvSerialization.hpp>\n')

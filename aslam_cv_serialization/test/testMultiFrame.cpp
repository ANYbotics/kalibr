...
#include <sm_kinematics/UncertainTransformation.hpp>
#include <sm_common/string_routines.hpp>
#include <aslam/feature_converters.hpp>
#include <aslam/SurfDescriptor.hpp>
#include <boost/serialization/export.hpp>
#include <boost/make_shared.hpp>
#include <aslam_cv_serialization/FrameBaseSerialization.hpp>
...
boost::shared_ptr<
  ...
  // Add keypoints. see aslam_frames/include/aslam_cameras/Keypoint.hpp
  ...
  for (int i = 0; i < N; ++i) {
    ...
    /// see aslam_frames/include/aslam_cameras/Frame.hpp

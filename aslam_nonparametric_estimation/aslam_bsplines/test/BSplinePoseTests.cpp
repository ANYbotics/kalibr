...
#include <sm_kinematics/transformations.hpp>
#include <sm_kinematics/RotationVector.hpp>
#include <sm_kinematics/EulerRodriguez.hpp>
#include <sm_kinematics/EulerAnglesYawPitchRoll.hpp>
#include <sm_kinematics/EulerAnglesZYX.hpp>
#include <stdio.h>
    ...
    rvs.reset(new RotationVector());
        ...
        for(int order = 2; order < 10; order++)
        {
          ...
          //  bs.addPoseSegment(2.0,bs.curveValueToTransformation(Eigen::VectorXd::Random(6)));
            ...
            aslam_sparse_block_matrix::SparseBlockMatrix<Eigen::MatrixXd> Q_sparse = bs.curveQuadraticIntegralSparse(W, 0);
    ...
    try {
        ...
        for(int order = 2; order < 10; order++)
        {
         ...
         //   bs.addPoseSegment(2.0,bs.curveValueToTransformation(Eigen::VectorXd::Random(6)));
            ...
            aslam_sparse_block_matrix::SparseBlockMatrix<Eigen::MatrixXd> Q_sparse = bs.curveQuadraticIntegralDiagSparse(W, 0);

...
boost::python::tuple orientationAndJacobianWrapper(const aslam_bsplines::BSplinePose * bsp, double t)
{
  Eigen::MatrixXd J;
  Eigen::VectorXi I;
...
boost::python::tuple inverseOrientationAndJacobianWrapper(const aslam_bsplines::BSplinePose * bsp, double t)
{
  Eigen::MatrixXd J;
  Eigen::VectorXi I;
...
boost::python::tuple transformationAndJacobianWrapper(const aslam_bsplines::BSplinePose * bsp, double t)
{
  Eigen::MatrixXd J;
  Eigen::VectorXi I;
...
boost::python::tuple inverseTransformationAndJacobianWrapper(const aslam_bsplines::BSplinePose * bsp, double t)
{
  Eigen::MatrixXd J;
  Eigen::VectorXi I;
...
boost::python::tuple angularVelocityAndJacobianWrapper(const aslam_bsplines::BSplinePose * bsp, double t)
{
  Eigen::MatrixXd J;
...
boost::python::tuple angularVelocityBodyFrameAndJacobianWrapper(const aslam_bsplines::BSplinePose * bsp, double t)
{
  Eigen::MatrixXd J;
  Eigen::VectorXi coefficientIndices;
...
boost::python::tuple linearAccelerationAndVelocityWrapper(const aslam_bsplines::BSplinePose * bsp, double t)
{
  Eigen::MatrixXd J;
  Eigen::VectorXi coefficientIndices;
...
boost::python::tuple angularAccelerationAndJacobianWrapper(const aslam_bsplines::BSplinePose * bsp, double t)
{
  Eigen::MatrixXd J;
  Eigen::VectorXi coefficientIndices;
...
boost::python::tuple angularAccelerationBodyFrameAndJacobianWrapper(const aslam_bsplines::BSplinePose * bsp, double t)
{
  Eigen::MatrixXd J;
  Eigen::VectorXi coefficientIndices;
...
{
  using namespace aslam_bsplines;

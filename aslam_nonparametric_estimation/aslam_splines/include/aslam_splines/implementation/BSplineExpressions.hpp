namespace aslam {
  namespace splines {
    ...
    template<int D>
    BSplineVectorExpressionNode<D>::BSplineVectorExpressionNode(aslam_bsplines::BSpline * spline, int derivativeOrder, const std::vector<aslam::backend::DesignVariable *> & designVariables, double time) :

...
#include <sm_eigen/NumericalDiff.hpp>
#include <sm_kinematics/Transformation.hpp>
#include <aslam_splines/OPTBSpline.hpp>
#include <aslam_splines/OPTUnitQuaternionBSpline.hpp>
#include <aslam_bsplines/EuclideanBSpline.hpp>
#include <aslam_bsplines/UnitQuaternionBSpline.hpp>
#include <aslam_bsplines/NsecTimePolicy.hpp>
...
#include <aslam_backend_expressions/Vector2RotationQuaternionExpressionAdapter.hpp>
#include <aslam_backend_expressions/ErrorTermTransformation.hpp>
#include <aslam_backend_expressions/DesignVariableMinimalDifferenceExpression.hpp>
#include <aslam_backend/backend/test/ErrorTermTestHarness.hpp>
#include <aslam_backend/backend/test/ExpressionTests.hpp>
#include <aslam_backend/backend/test/RotationExpressionTests.hpp>
#include <aslam_backend/backend/GenericScalar.hpp>
#include <aslam_backend/backend/Optimizer.hpp>
#include <aslam_backend/backend/OptimizationProblem.hpp>
#include <aslam_backend/backend/ExpressionErrorTerm.hpp>
#include <aslam_backend_expressions/VectorExpressionToGenericMatrixTraits.hpp>

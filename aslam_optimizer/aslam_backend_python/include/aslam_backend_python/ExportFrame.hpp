...
#include <aslam_cv_error_terms/ReprojectionError.hpp>
#include <aslam_cv_error_terms/CovarianceReprojectionError.hpp>
#include <aslam_cv_error_terms/SimpleReprojectionError.hpp>
//#include <aslam_backend/backend/ReprojectionIntrinsicsError.hpp>
#include <aslam_backend_expressions/HomogeneousExpression.hpp>
#include <aslam_cv_backend/CameraDesignVariable.hpp>

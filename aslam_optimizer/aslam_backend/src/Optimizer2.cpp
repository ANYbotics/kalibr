...
#include <aslam_backend/backend/SparseQrLinearSystemSolver.hpp>
#endif
#include <aslam_backend/backend/sparse_matrix_functions.hpp>
#include <aslam_backend/backend/BlockCholeskyLinearSystemSolver.hpp>
#include <aslam_backend/backend/SparseCholeskyLinearSystemSolver.hpp>
#include <aslam_backend/backend/DenseQrLinearSystemSolver.hpp>
#include <sm_property_tree/PropertyTree.hpp>

...
#include <aslam_cameras/cameras/CameraGeometryBase.hpp>
#include <sm_python/Id.hpp>
...
void exportCameraGeometryBase() {
  ...
  boost::python::class_<aslam::cameras::CameraGeometryBase,
      ...
      .def("estimateTransformation", &detail::estimateTransformation<CameraGeometryBase>, "estimate the transformation of the camera with respect to the calibration target, returns tuple (bool, sm_python.Transformation)")

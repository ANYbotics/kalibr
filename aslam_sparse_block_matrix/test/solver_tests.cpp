...
void randomSparseBlockMatrix(aslam_sparse_block_matrix::SparseBlockMatrix<typename SOLVER_T::matrix_t> * A,   Eigen::MatrixXd & Adense ) {
...
{  
  ...
  int rows[] = {3,6,11};
  int cols[] = {3,6,11};
  aslam_sparse_block_matrix::SparseBlockMatrix<typename SOLVER_T::matrix_t> A(rows,cols,3,3);
...
//
   testSolver< aslam_sparse_block_matrix::LinearSolverQr<Eigen::MatrixXd> >("sparseQR");
  
  testSolver< aslam_sparse_block_matrix::LinearSolverCholmod<Eigen::MatrixXd> >("cholmod");

  testSolver< aslam_sparse_block_matrix::LinearSolverDense<Eigen::MatrixXd> >("dense");

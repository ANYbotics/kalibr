...
#include <aslam_aslam_bsplines/BSplinePose.hpp>
...
class BSplineMotionError : public ErrorTermFs<1> {
 public:
  ...
  typedef aslam_sparse_block_matrix::SparseBlockMatrix<Eigen::MatrixXd> sbm_t;
 ...
 private:
  ...
  void initialize(spline_t * splineDV, Eigen::MatrixXd W,
                  unsigned int errorTermOrder);

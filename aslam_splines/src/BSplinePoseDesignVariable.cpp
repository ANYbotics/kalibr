...
namespace aslam {
    namespace splines {
        ...
        BSplinePoseDesignVariable::BSplinePoseDesignVariable(const aslam_bsplines::BSplinePose & bsplinePose) :
        ...
        const aslam_bsplines::BSplinePose & BSplinePoseDesignVariable::spline()
        {
            return _bsplinePose;
        }

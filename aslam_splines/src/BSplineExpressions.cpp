#include <aslam_splines/BSplineExpressions.hpp>
#include <aslam_splines/BSplinePoseDesignVariable.hpp>

namespace aslam {
    namespace splines {
    
        BSplineTransformationExpressionNode::BSplineTransformationExpressionNode(aslam_bsplines::BSplinePose * spline, const std::vector<aslam::backend::DesignVariable *> & designVariables, double time) :
        ...
        BSplineRotationExpressionNode::BSplineRotationExpressionNode(aslam_bsplines::BSplinePose * spline, const std::vector<aslam::backend::DesignVariable *> & designVariables, double time) :
            _spline(spline), _designVariables(designVariables), _time(time)
        {
        ...
        BSplinePositionExpressionNode::BSplinePositionExpressionNode(aslam_bsplines::BSplinePose * spline, const std::vector<aslam::backend::DesignVariable *> & designVariables, double time) :
            _spline(spline), _designVariables(designVariables), _time(time)
        {
        ...
        BSplineVelocityExpressionNode::BSplineVelocityExpressionNode(aslam_bsplines::BSplinePose * spline, const std::vector<aslam::backend::DesignVariable *> & designVariables, double time) :
            _spline(spline), _designVariables(designVariables), _time(time)
        {
        ...
        BSplineAccelerationExpressionNode::BSplineAccelerationExpressionNode(aslam_bsplines::BSplinePose * spline, const std::vector<aslam::backend::DesignVariable *> & designVariables, double time) :
            _spline(spline), _designVariables(designVariables), _time(time)
        {
    ...
    BSplineAccelerationBodyFrameExpressionNode::
        BSplineAccelerationBodyFrameExpressionNode(
        aslam_bsplines::BSplinePose* spline,
    ...
    void BSplineAccelerationBodyFrameExpressionNode::
      ...
      for (size_t i = 0; i < _designVariables.size(); ++i)
        ...
        ///////////////////
        BSplineAngularVelocityBodyFrameExpressionNode::BSplineAngularVelocityBodyFrameExpressionNode(aslam_bsplines::BSplinePose * spline, const std::vector<aslam::backend::DesignVariable *> & designVariables, double time) :
            _spline(spline), _designVariables(designVariables), _time(time)
        {
        ...
        BSplineEuclideanExpressionNode::BSplineEuclideanExpressionNode(aslam_bsplines::BSpline * spline, const std::vector<aslam::backend::DesignVariable *> & designVariables, double time, int order) :
        ...
        BSplineAngularAccelerationBodyFrameExpressionNode::BSplineAngularAccelerationBodyFrameExpressionNode(aslam_bsplines::BSplinePose * spline, const std::vector<aslam::backend::DesignVariable *> & designVariables, double time) :
        _spline(spline), _designVariables(designVariables), _time(time)
        {

...
#include <aslam_cameras/frontend_ids.hpp>
#include <aslam_cameras/KeypointBase.hpp>
#include <aslam_cameras/DescriptorBase.hpp>
#include <aslam_cameras/KeypointIdentifier.hpp>
#include <sm_kinematics/UncertainVector.hpp>
#include <sm_kinematics/UncertainHomogeneousPoint.hpp>
#include <sm_common/serialization_macros.hpp>

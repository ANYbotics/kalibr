...
#include <aslam_backend/Exceptions.hpp>
#include <sm_eigen/assert_macros.hpp>
namespace aslam {
  namespace backend {


    void applySchurComplement(aslam_sparse_block_matrix::SparseBlockMatrix<Eigen::MatrixXd>& H,
                              const Eigen::VectorXd& rhs,
                              double lambda,
                              int marginalizedStartingBlock,
                              bool doLevenbergMarquardt,
                              aslam_sparse_block_matrix::SparseBlockMatrix<Eigen::MatrixXd>& A,
                              std::vector<Eigen::MatrixXd>& invVi,
                              Eigen::VectorXd& b)
    {
      typedef aslam_sparse_block_matrix::SparseBlockMatrix<Eigen::MatrixXd> SparseBlockMatrix;
    ...
    void buildDsi(int i,
                  aslam_sparse_block_matrix::SparseBlockMatrix<Eigen::MatrixXd>& H,
